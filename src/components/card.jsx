    ...
    >
      <div className=" rounded-[20px] flex flex-col align-middle content-center items-center ">
        ...
        <div className=" max-h-[250px]  max-w-[200px] min-h-[250px] min-w-[200px]  flex rounded-[20px]  ">
          ...
          {!product.images[1] && (
            <article className="w-full bg-slate-800 animate-pulse rounded-[20px] max-h-[240px]  max-w-[200px] min-h-[240px] min-w-[200px] flex justify-center">
              <img
                className=""
        ...
        <div className="grid grid-cols-[78%_1%] gap-1 ">
          <div>
            <p className=" text-sm hover:text-slate-100 hover:font-medium text-start">
              {" "}
              {product.description}{" "}
            </p>
          </div>
          <div className=" flex flex-wrap gap-5 items-start">
            <button className="bg-cyan-300/50 flex min-h-5  max-h-7 min-w-[60px] max-w-[60px] rounded-xl hover:bg-cyan-300/80">
              {" "}
              <img
                className="max-h-[25px]"
                src="https://cdn-icons-png.flaticon.com/128/126/126229.png"
                alt="$"
              />
              {product.price}
            </button>
